...
function App() {
  ...
  return (
    <>
      <header className='flex items-center gap-8 px-4 py-8 md:px-0'>
        <img src="./logo.svg" alt=" "/>
        <div className='hidden justify-between items-center w-full text-violet1 font-bold md:flex'>
          <nav>
      ...
      <main className='text-lg'>
        <section className='relative z-10 flex flex-col items-center'>
          <div className='md:flex md:flex-row-reverse'>
            ...
            <div className='flex flex-col items-center md:items-start'>
              <h1 className='mt-4 text-4xl text-darkBlue text-center font-bold md:text-7xl md:text-left'>More than just shorter links</h1>
              <p className='mt-4 text-lg text-gray text-center max-w-introMobile md:text-xl md:text-left md:max-w-introDesktop'>Build your brand&apos;s recognition and get detailed insights on how your links are performing.</p>
              <a className='mt-8 px-8 py-2 text-lg text-white font-bold bg-cyan rounded-full'>Get Started</a>
            </div>
          </div>
          <form className='relative -bottom-20 flex flex-col gap-6 p-6 bg-mobileFormBg bg-no-repeat bg-right-top bg-origin-padding bg-violet2 rounded-md md:bg-desktopFormBg md:flex-row md:justify-center md:w-full md:p-12 md:bg-left md:bg-cover'>
            <input className="text-lg px-4 py-2 bg-white rounded md:w-9/12" type="text" placeholder='Shorten a link here...'/>
            <button className='px-4 py-2 text-lg text-white font-bold bg-cyan rounded-md md:px-8 md:py-4'>Shorten it!</button>
          </form>
        </section>
        <section className='relative left-1/2 -z-1 w-screen -translate-x-1/2 flex flex-col gap-28 bg-grayishBlue px-4 py-16 text-center'>
          <div className='mt-28'>
        ...
        <section className='relative left-1/2 -z-2 flex flex-col justify-center items-center gap-4 px-4 py-24 w-screen -translate-x-1/2 bg-violet2 bg-mobileBoostBg bg-no-repeat bg-cover bg-right bg-origin-padding md:bg-desktopBoostBg'>
      ...
      <footer className='relative -z-3 left-1/2 w-screen -translate-x-1/2  flex flex-col items-center justify-center px-4 py-12 bg-violet3'>
